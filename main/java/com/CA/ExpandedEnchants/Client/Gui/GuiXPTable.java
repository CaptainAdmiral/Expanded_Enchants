package com.CA.ExpandedEnchants.Client.Gui;
...
public class GuiXPTable extends GuiContainer
{
    private static final ResourceLocation field_147078_C = new ResourceLocation(EEMain.MODID, "textures/gui/enchanting_table.png");
    ...
    private ContainerXPTable field_147075_G;
    ...
    public GuiXPTable(InventoryPlayer par1InventoryPlayer, World par2World, int par3, int par4, int par5, String par6Str)
    {
        super(new ContainerXPTable(par1InventoryPlayer, par2World, par3, par4, par5));
        this.field_147075_G = (ContainerXPTable)this.inventorySlots;
    ...
    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_)
    {
        ...
        RenderHelper.disableStandardItemLighting();
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        EnchantmentNameParts.getInstance().reseedRandomGenerator(this.field_147075_G.nameSeed);
